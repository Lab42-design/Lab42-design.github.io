...
namespace Lab42\Database;

use Lab42\Database\Helpers\{Validate,
    Config};
...
class Relation
{
     ...
     * @return self
     */
    public static function table($name): Relation
    {
     ...
     */
    protected function setRelationType($relation): void
    {
     ...
     */
    protected function setTable($type, $name): void
    {
        Validate::table($name)->exists();
     ...
     * @return self
     */
    public function belongsTo($table): DatabaseCollection
    {
     ...
     * @return self
     */
    public function hasMany($table): DatabaseCollection
    {
        $this->setTable('foreign', $table);
        $this->setRelationType(__FUNCTION__);
     ...
     * @return self
     */
    public function hasAndBelongsToMany($table): DatabaseCollection
    {
        $this->setTable('foreign', $table);
        $this->setRelationType(__FUNCTION__);
     ...
     * @return self
     */
    public function with($table): DatabaseCollection
    {
     ...
     * @return array
     */
    public function build(array $array, $part): array
    {
        $return = [];
