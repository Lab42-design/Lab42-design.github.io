...
namespace Lab42\Database\Helpers;

use Lab42\Database\DatabaseException;
...
class File implements FileInterface {
    ...
    public final function getPath(): string
    {
        ...
        {
            throw new DatabaseException('Please define constant LAZER_DATA_PATH (check README.md)');
        }
